  ...
  return (
    <div className="w-screen h-auto flex flex-col items-center relative">
      ...
      <div className=" w-[80%] min-h-screen flex flex-col items-center justify-center">
        <h1 className="text-[5rem]  font-semibold text-[#bde148] z-10 mt-12 ">
          Level Up Your Coding Skills
        </h1>
        <div className="w-full h-[10rem] flex justify-center items-center">
          <div className="w-[60%] h-[40%] rounded-[10rem]  bg-slate-600 flex justify-between items-center sticky top-5 z-50">
            <input
              type="text"
              className="w-[85%] h-[100%] rounded-[10rem] p-5 px-10 bg-transparent outline-none text-[1.3rem] font-medium text-white"
              placeholder="Search Course"
              onChange={(e) => handleSearch(e)}
            />
            {/* <div className="w-[20%] h-[100%] rounded-[10rem] bg-lime-400"></div> */}
          </div>
        </div>
